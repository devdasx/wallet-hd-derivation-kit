...
- [ ] Verify the IndexNow workflow accepted the sitemap URLs for Bing and participating engines.
- [ ] Publish `marketing/GITHUB_DISCUSSION.md` in the repository’s Announcements category.
- [ ] Review Reddit, Hacker News, X, and LinkedIn drafts before any external post.
- [ ] Only after all new-release checks pass: redirect and archive `hd-extended-key-kit` without deleting history or releases.
